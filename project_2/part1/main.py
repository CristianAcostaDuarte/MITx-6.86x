...
# print('Linear Regression test_error =', run_linear_regression_on_MNIST(lambda_factor=1), "lambda = ", 1)
# print('Linear Regression test_error =', run_linear_regression_on_MNIST(lambda_factor=1), "lambda = ", .1)
# print('Linear Regression test_error =', run_linear_regression_on_MNIST(lambda_factor=1), "lambda = ", .01)
...
# print('softmax test_error T 0.5=', run_softmax_on_MNIST(temp_parameter=0.5))
# print('softmax test_error T 1.0=', run_softmax_on_MNIST(temp_parameter=1))
# print('softmax test_error T 2.0=', run_softmax_on_MNIST(temp_parameter=2))
...
print('softmax on MNIST mod 3', run_softmax_on_MNIST_mod3(temp_parameter=1.0))
